          ...
          : e.length > 1
            ...
            : ((d = {}),
              ...
              (f = function () {
                if (
                  (0 ===
                    a("." + d.settings.fillerClass, d.vars.slideWrapper)
                      .length &&
                    d.vars.slideWrapper.append(
                      a('<div class="' + d.settings.fillerClass + '" />'),
                    ),
                  ...
                  (c = 0),
                    ...
                    a(d.vars.slides).each(function () {
                      a(this).height() > c && ((b = a(this)), (c = b.height())),
                        (f += 1),
                        f === d.vars.count &&
                          (void 0 === b && (b = a(a(d.vars.slides)[0])), g(b));
                    });
                }
              }),
              (p = function () {
                d.settings.pager &&
                  (a(
                    "." + d.settings.pagerClass + " li",
                    d.vars.slippryWrapper,
                  ).removeClass(d.settings.activeClass),
                  a(
                    a(
                      "." + d.settings.pagerClass + " li",
                      d.vars.slippryWrapper,
                    ...
                    function () {
                      (d.vars.autodelay = !1),
                        (d.vars.timer = window.setInterval(function () {
                          (d.vars.trigger = "auto"),
                            t(d.settings.autoDirection);
                        }, d.settings.pause));
                    },
                    d.vars.autodelay
                      ? d.settings.autoHoverDelay
                      : d.settings.autoDelay,
                  )),
                  d.settings.autoHover &&
                    d.vars.slideWrapper
                      ...
                      .bind("mouseleave", function () {
                        d.vars.hoverStop &&
                          ((d.vars.autodelay = !0), e.startAuto());
                      }));
              }),
              (e.stopAuto = function () {
              ...
              (m = function () {
                (d.vars.moving = !1),
                  ...
                  d.settings.auto &&
                    ((d.vars.hoverStop && void 0 !== d.vars.hoverStop) ||
                      e.startAuto());
              }),
              (r = function () {
                var b, c, f, g, h, i, j;
                            ...
                            : d.settings.useCSS
                              ? (d.vars.old
                                ...
                                a(window)
                                  ...
                                  .on("focus", function () {
                                    d.vars.moving &&
                                      d.vars.old.trigger(d.vars.transition);
                                  }),
                ...
                d.vars.moving ||
                  ...
                  "prev" === b
                    ? ((f = b),
                      c > 0
                        ? (b = c - 1)
                        : d.settings.loop && (b = d.vars.count - 1))
                    : "next" === b
                      ? ((f = b),
                        c < d.vars.count - 1
                          ? (b = c + 1)
              ...
              (j = function () {
                if (d.settings.pager && d.vars.count > 1) {
                  ...
                  d.vars.slippryWrapper.append(e),
                    a(
                      "." + d.settings.pagerClass + " a",
                      d.vars.slippryWrapper,
                    ).click(function () {
                      return (
                        (d.vars.trigger = "pager"),
                        t(parseInt(this.hash.split("#")[1], 10)),
                        !1
                      );
                    }),
                    p();
              ...
              (k = function () {
                d.settings.controls &&
                  ...
                  a(
                    "." + d.settings.controlClass + " a",
                    d.vars.slippryWrapper,
                  ).click(function () {
                    return (
                      (d.vars.trigger = "controls"),
                      t(this.hash.split("#")[1]),
                      !1
                    );
                  }),
              ...
              (o = function () {
                d.settings.captions !== !1 &&
                  ("overlay" === d.settings.captions
                    ? d.vars.slideWrapper.append(
                        a('<div class="sy-caption-wrap" />').html(
                          z("<div />", d.settings.captionsEl),
                        ),
                      )
              ...
              (h = function () {
                ...
                return (
                  ...
                  d.settings.useCSS &&
                    (w("transition") || (d.settings.useCSS = !1),
                    (d.vars.transition = n())),
                  ...
                  d.vars.slides.each(function () {
                    a(this).addClass("sy-slide " + d.settings.transition),
                      ...
                      "horizontal" === d.settings.transition
                        ? a(this).css(
                            "left",
                            a(this).index() * (100 + d.settings.slideMargin) +
                              "%",
                          )
                        : "vertical" === d.settings.transition &&
                          a(this).css(
                    ...
                    ? (-1 === a("." + d.settings.activeClass, e).index()
                        ? ((f =
                            "random" === d.settings.start
                              ...
                              : d.settings.start > 0 &&
                                  d.settings.start <= d.vars.count
                                ? d.settings.start - 1
                                : 0),
                          (d.vars.active = a(d.vars.slides[f]).addClass(
